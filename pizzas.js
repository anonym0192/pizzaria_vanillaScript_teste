...
let pizzaJson = [
    ...
    description:'Molho, mussarela, tomate em rodelas e orégano.', sizes: ['BROTO','PEQUENA','MÉDIA','GRANDE']},
    
    {id:2, name:'Calabresa', img:'images/calabresa.png', price:{broto: 24.90, pequena: 35.90, media: 46.90, grande: 57.90}, 
    description:'Molho, mussarela, calabresa, cebola fatiada e orégano.', sizes: ['BROTO','PEQUENA','MÉDIA','GRANDE']},
    
    {id:3, name:'Portuguesa', img:'images/portuguesa.png', price:{broto: 25.90, pequena: 39.90, media: 56.90, grande: 67.90}, 
    description:'Molho, mussarela, presunto, calabresa, ovos, cebola, azeitonas e orégano.', sizes: ['BROTO','PEQUENA','MÉDIA','GRANDE']},
    
    {id:4, name:'Chocolate', img:'images/chocolate.png', price:{broto: 24.90, pequena: 35.90, media: 46.90, grande: 57.90}, 
    description:'Mussarela, chocolate ao leite.', sizes: ['BROTO','PEQUENA','MÉDIA','GRANDE']},
    
    {id:5, name:'5 Queijos', img:'images/cinco-queijos.png', price:{broto: 25.90, pequena: 39.90, media: 56.90, grande: 57.90}, 
    description:'Molho, mussarela, provolone, gorgonzola, parmesão, catupiry e orégano.', sizes: ['BROTO','PEQUENA','MÉDIA','GRANDE']},
    
    {id:6, name:'Napolitana', img:'images/napolitana.png', price:{broto: 25.90, pequena: 39.90, media: 56.90, grande: 67.90}, 
